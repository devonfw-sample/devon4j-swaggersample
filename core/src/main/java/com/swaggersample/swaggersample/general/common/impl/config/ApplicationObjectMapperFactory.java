package com.swaggersample.swaggersample.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the swaggersample application.
 */
